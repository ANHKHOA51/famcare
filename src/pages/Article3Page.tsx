    ...
    <>
      ...
      <main className="relative z-20 bg-neutral-50 -mt-8 mx-auto w-full max-w-6xl rounded-t-[2.5rem] px-4 sm:px-12 lg:px-24 py-16 text-[1.125rem] text-slate-800 leading-[1.9] font-light shadow-[0_-20px_40px_rgba(0,0,0,0.05)]">
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <SocialShareButtons 
            title="Hệ sinh thái FamCare: Giải pháp toàn diện chăm sóc sức khỏe gia đình"
            url="https://famcare.site/resources/he-sinh-thai-famcare-giai-phap-toan-dien"
            description="Khám phá hệ sinh thái FamCare - nền tảng y tế số toàn diện"
          />
