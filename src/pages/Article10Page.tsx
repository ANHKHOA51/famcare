  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="uống thuốc bằng nước trà, tương tác thuốc và trà, có nên uống thuốc bằng trà không, uống thuốc với nước gì tốt nhất, tác hại của việc uống thuốc bằng trà, phòng tránh tương tác thuốc, uống thuốc với nước lọc, tương tác thuốc với đồ uống, tương tác thuốc với trà xanh, an toàn uống thuốc"
        />

        <link
          rel="canonical"
          href="https://famcare.site/resources/co-nen-uong-thuoc-bang-nuoc-tra"
        />
        ...
        <meta
          ...
          content="Hiểu những tương tác thuốc cần tránh khi uống với nước trà để bảo vệ sức khỏe."
        />
        ...
        <meta
          property="og:url"
          content="https://famcare.site/resources/co-nen-uong-thuoc-bang-nuoc-tra"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            "headline": "Có nên uống thuốc bằng nước trà? Những tương tác thuốc bạn nhất định phải biết",
            "description": "Việc uống thuốc bằng nước trà có thể làm giảm hiệu quả điều trị hoặc gây ra các phản ứng phụ nguy hiểm. Khám phá những tương tác thuốc cần tránh.",
            "image": "https://famcare.site/bai-10/hinh1.jpg",
            ...
            "mainEntityOfPage": {"@type": "WebPage", "@id": "https://famcare.site/resources/co-nen-uong-thuoc-bang-nuoc-tra"}
          })}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-slate-50 selection:bg-cyan-200 selection:text-cyan-900 font-body pb-10">
        ...
        <main className="px-4 sm:px-8 lg:px-16 py-10 max-w-[860px] mx-auto text-[1.125rem] text-slate-800 leading-[1.85] font-light">
          ...
          <SocialShareButtons 
            title="Có nên uống thuốc bằng nước trà? Những tương tác thuốc bạn nhất định phải biết"
            url="https://famcare.site/resources/co-nen-uong-thuoc-bang-nuoc-tra"
            description="Khám phá những tương tác thuốc với nước trà"
          />
          ...
          <div className="mt-20 pt-16 border-t-2 border-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link to="/resources/quen-uong-thuoc-thi-co-sao-khong" className="p-6 border border-slate-200 rounded-xl hover:border-cyan-400 hover:shadow-md transition-all group">
                ...
                <p className="text-slate-600 text-sm">Hướng dẫn xử lý an toàn khi quên liều.</p>
              </Link>
