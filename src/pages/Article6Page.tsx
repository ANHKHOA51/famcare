  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="thuốc thiết yếu, tủ thuốc gia đình, tên các loại thuốc thường dùng, những loại thuốc cần có trong nhà khi có trẻ nhỏ, thuốc nên có sẵn trong nhà, thuốc căn bản cần có trong tủ thuốc gia đình"
        />
