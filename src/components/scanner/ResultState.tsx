...
function AutocompleteInput({ value, onChange, placeholder, className }: AutocompleteInputProps) {
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      />
      {showSuggestions && (
        <ul className="absolute top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 overflow-hidden max-h-56 overflow-y-auto">
          {suggestions.map((s) => (
            <li
              key={s}
